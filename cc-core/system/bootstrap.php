...
$config->acceptedVideoFormats = array('flv', 'wmv', 'avi', 'ogg', 'mpg', 'mp4', 'mov', 'm4v', '3gp', 'rmvb');
$config->acceptedAvatarFormats = array('png', 'jpeg', 'jpg', 'gif');
$config->h264Url = 'http://freedom-owen.oss-cn-hangzhou.aliyuncs.com/video';//HOST . '/cc-content/uploads/h264';
...
$config->thumbUrl =  'http://freedom-owen.oss-cn-hangzhou.aliyuncs.com/thumb'; //HOST . '/cc-content/uploads/thumbs';
