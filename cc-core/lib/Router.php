...
class Router
{
    ...
    protected function _staticRoutes()
    {
        ...
        $routes['ajax-alibaba-get-oss-sign'] = new Route(array(
            'path' => 'ajax/alibaba/get-oss-sign',
            'location' => DOC_ROOT . '/cc-core/controllers/ajax/alibaba/get_oss_sign.php',
            'name' => 'ajax-upload-get-oss-sign'
        ));
